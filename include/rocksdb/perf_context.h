...
struct PerfContext {
  ...
  uint64_t my_test_nanos=0;
  uint64_t my_read_filter_block_nanos=0;
  uint64_t my_read_index_block_nanos=0;
  uint64_t my_mem_get_nanos=0;
  uint64_t my_filter_check_nanos=0;
  uint64_t my_index_search_nanos=0;
  uint64_t my_data_search_nanos=0;
