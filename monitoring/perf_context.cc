...
std::string PerfContext::ToString(bool exclude_zero_counters) const {
  ...
  PERF_CONTEXT_OUTPUT(my_read_filter_block_nanos);
  PERF_CONTEXT_OUTPUT(my_read_index_block_nanos);
  PERF_CONTEXT_OUTPUT(my_mem_get_nanos);
  PERF_CONTEXT_OUTPUT(my_filter_check_nanos);
  PERF_CONTEXT_OUTPUT(my_index_search_nanos);
  PERF_CONTEXT_OUTPUT(my_data_search_nanos);
